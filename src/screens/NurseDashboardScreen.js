...
const NurseDashboardScreen = ({navigation, route}) => {
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          ...
          <View>
            ...
            <Text style={styles.headerTagline}>Nurse Portal</Text>
          </View>
        </View>
      ...
      <ScrollView
        ...
        <Animated.View
          ...
          <View style={styles.welcomeCard}>
            <View style={styles.welcomeInfo}>
              ...
              <Text style={styles.welcomeName}>
                {userData?.name || 'Nurse'} 👩‍⚕️
              </Text>
              <View style={styles.badge}>
                <Text style={styles.badgeText}>NURSE</Text>
              </View>
            </View>
          </View>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
              <View style={styles.quickActionsRow}>
                <QuickAction
                  ...
                  label="My Profile"
                  onPress={() =>
                    navigation.navigate(SCREENS.NURSE_PROFILE, {
                ...
                <QuickAction
                  ...
                  label="My Patients"
                  onPress={() =>
                    navigation.navigate(SCREENS.ASSIGNED_PATIENTS, {
                      nurseId: userData?.userId,
                    })
                  }
                />
          ...
          {/* Overview Stat Placeholders */}
          <Text style={styles.sectionTitle}>Ward Overview</Text>
          ...
          <View style={styles.infoCard}>
            ...
            <Text style={styles.infoText}>
              Patient assignments, shifts, and ward details will be sync'd
              dynamically when corresponding telemetry and assignment APIs are
              live.
            </Text>
          </View>
        </Animated.View>
