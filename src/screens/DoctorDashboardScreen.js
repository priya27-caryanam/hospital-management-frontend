      ...
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          ...
          <View>
            ...
            <Text style={styles.headerTagline}>Doctor Portal</Text>
          </View>
        </View>
        ...
        <Animated.View
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
              <View style={styles.quickActionsRow}>
                <QuickAction
                  ...
                  label="My Profile"
                  onPress={() =>
                    navigation.navigate(SCREENS.DOCTOR_DETAILS, {
                ...
                <QuickAction
                  ...
                  label="My Appts"
                  onPress={() =>
                    navigation.navigate(SCREENS.DOCTOR_APPTS, {
                      doctorId: userData?.userId,
                    })
                  }
                />
          ...
          <View style={styles.infoCard}>
            ...
            <Text style={styles.infoText}>
              Statistics and dashboard reporting metrics will be populated when
              background analytics APIs are active. Use Quick Actions above to
              access features.
            </Text>
          </View>
        </Animated.View>
